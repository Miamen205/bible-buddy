...
import config from '../../OpenTokConfig.json';
import '../../components/VideoChat/VideoChat.css';
...
const otCoreOptions = {
  ...
  textChat: {
    name: ['Eddie', 'Goerge', 'William', 'Atijar', 'Isha'][Math.random() * 5 | 0], // eslint-disable-line no-bitwise
